...
public class CarritoController {
    ...
    public String inicio(Model model) {
        ...
        java.math.BigDecimal carritoTotalVenta = java.math.BigDecimal.ZERO;
        for (Item i : items) {
            carritoTotalVenta = carritoTotalVenta.add(i.getPrecio().multiply(java.math.BigDecimal.valueOf(i.getCantidad())));
        }
