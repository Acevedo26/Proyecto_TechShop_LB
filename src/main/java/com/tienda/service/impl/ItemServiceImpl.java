...
public class ItemServiceImpl implements ItemService {
    ...
    public void facturar() {
        ...
        for (Item i : listaItems) {
            java.math.BigDecimal subtotal = i.getPrecio().multiply(java.math.BigDecimal.valueOf(i.getCantidad()));
            System.out.println("Producto: " + i.getDescripcion()
                    + " Cantidad: " + i.getCantidad()
                    + " Total: " + subtotal);
            Venta venta = new Venta(factura.getIdFactura(), i.getIdProducto(), i.getPrecio().doubleValue(), i.getCantidad());
            ventaDao.save(venta);
