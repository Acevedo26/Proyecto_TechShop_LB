...
public class RegistroServiceImpl implements RegistroService {
    ...
    public Model crearUsuario(Model model, Usuario usuario) throws MessagingException {
        ...
        if (!usuarioService.existeUsuarioPorUsernameOCorreo(usuario.getUsername(), usuario.getCorreo())) {
            ...
            mensaje = String.format(messageSource.getMessage("registro.mensaje.usuario.o.correo", null, Locale.getDefault()),
    ...
    public Model recordarUsuario(Model model, Usuario usuario) throws MessagingException {
        ...
        if (usuario2 != null) {
            ...
            mensaje = String.format(messageSource.getMessage("registro.mensaje.recordar.ok", null, Locale.getDefault()),
                    usuario.getCorreo());
        } else {
            mensaje = String.format(messageSource.getMessage("registro.mensaje.usuario.o.correo", null, Locale.getDefault()),
                    usuario.getUsername(), usuario.getCorreo());
